...
WiHi **doesn't** seek to change this. In fact, we believe that, through well-designed cryptoeconomics, we can both improve the public good and build an economically-sustainable network of high quality _and_ dense observations of our environment.
...
Moreover, weather forecasts and climate monitoring are offered freely as public goods.

### Current landscape 

Public institutions, such as national meteorological agencies (met agencies), capture high quality data that is used to provide publicly available weather and climate forecasts. Increasingly, the underlying high quality data is also made available in the public domain _free of charge_. As publicly funded institutions, met agencies are severely constrained in the scale by which they can make high quality observations. 
...
Although WiHi is unique amongst DePINs since we do not sell our own hardware, WiHi is
