...
WiHi uses cryptoeconomics to coordinate the complex weather and climate communities such that enhanced forecasts and data are delivered cost-effectively to customers:
...
are logged transparently and immmutably and determine the revenue sharing, while transparent mechanisms are in place guaranteeing data quality.
...
These different forecasting experts compete in a playful manner with each other and commit their predictions to the platform, each honest contribution being rewarded.
...
In fact, WiHi unleashes and leverages the weather communities collecitve intelligence!
