...
This approach to usage rewarding implicitly incentivizes the properties incentivized by the base rewards:
Because Miners only receive rewards when their data is used, they have to make sure
- to share high-quality/ useful data. Low-quality data will quickly be discovered by future services and hence not used.
- to have up-time, as incomplete data sets will be less useful to services than complete sets
- to contribute unique data, as redundant data competes with each other for usage rewards
