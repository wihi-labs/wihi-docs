...
WiHi will be able to access the useability of data for that forecaster and issue base rewards according to this utility.
...
Nevertheless, contributions are already being encouraged now to share, as an important factor for the reward is the **length of time a miner has contributed data** to the WiHi network - the longer, the better - starting already now.
...
to join one of our supporter programs and obtain rewards associated with those activities already now. 
